...
const appStylesBase = {
  // Give me padding
  cellContainer: {
    paddingHorizontal: Sizes.paddingXSml,
...
export default {
  ...
  semiboldText: {
    fontFamily: Fonts.heavy.family,
    fontSize: Fonts.heavy.size,
    color: Colors.textPrimary,
  },

  boldText: {
    fontFamily: Fonts.black.family,
    fontSize: Fonts.black.size,
    color: Colors.textPrimary,
  },
  ...
  bookText: {
    fontFamily: Fonts.book.family,
    fontSize: Fonts.book.size,
    color: Colors.textPrimary,
  },
  ...
  subTextSemibold: {
    fontFamily: Fonts.heavy.family,
    fontSize: Fonts.heavy.size * 0.75,
    lineHeight: parseInt(Fonts.heavy.lineHeight * 0.75, 10),
    color: Colors.textSecondary,
  },
  tinyText: {
    fontFamily: Fonts.base.family,
