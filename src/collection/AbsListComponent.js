...
class AbsListComponent<Response, Item, PagingData> extends Component
  ...
  start() {
    ...
    const firstLoading = !this.pagingData || (this.state.pagingMode === CollectionMode.ERROR && this.pagingData.pageIndex == 0);
...
reactMixin(AbsListComponent.prototype, UnmountMixin);
